...
namespace Blog.Application.CQRS.Commands.AuthorizationEndpoint.AssignRoleEndpoint
{
    public class AssignRoleEndpointCommandHandler : IRequestHandler<AssignRoleEndpointCommandRequest, AssignRoleEndpointCommandResponse>
    {
        ...
        {
            bool succeeded = await _authorizationEndpointService.AssignEndpointForRoleAsync(request.roleId,request.endPointsCode,request.type);
            return new AssignRoleEndpointCommandResponse() { succeeded = succeeded };
        }
    }
}
